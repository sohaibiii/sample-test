        ...
        >
          ...
          <View style={styles.mainContainer}>
            <View style={styles.infoContainer}>
              ...
              <Text
                style={{lineHeight: 15}}
                typography={theme.typography.p}
              >
                Select a specific Pain location using the body map 
                and define its Severaity
              </Text>
            </View>
            <View>
              <Human height={450} />
            ...
            <Slider
              title="Select the Intensity Levels"
            />
          </View>
        </ScrollView>
        <NavigationContainer />
